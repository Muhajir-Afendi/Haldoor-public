...
<head>
    ...
    <title>Courses - Haldoor Technical and Vocational Center</title>
...
<body>
        ...
        <main id="main">
            ...
            <section id="breadcrumb" class="breadcrumb">
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="font-weight-light">Courses</h2>
            ...
            <section class="py-5">
                <div class="container">
                    ...
                    <!-- Auto mechanics -->
                    <div class="row mt-4 d-flex align-items-stretch courses-detail">
        
                        <div class="col-lg-5">
                            <i class="fas fa-wrench"></i>
                            <h4 class="mr-0">Auto mechanics</h4>
                        </div>
                    ...
                    <div class="row mt-4 d-flex align-items-stretch courses-detail">
                        <div class="col-lg-5">
                            <i class="material-icons-outlined">precision_manufacturing</i>
                            <h4>Tailoring</h4>
                        </div>
                        <div class="col-lg-7">
                            <p>
    ...
    <script> document.getElementById('courses-navigations').classList.add("active") </script>

...
<head>
    ...
    <title>Graduations - Haldoor Technical and Vocational Center</title>
...
<body>
            ...
            <section id="breadcrumb" class="breadcrumb">
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="font-weight-light">Graduations</h2>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            // Modals
                            $fetch_modal = "SELECT `id`, `title`, `body`, `image`, DATE_FORMAT(`created_at`, '%W, %M %d, %Y %l:%i %p') AS `created_at` FROM `graduations` ";                            
                        ...
                        ?>
                                    <div class="col-lg-12 mt-4">
                                        <div class="member d-flex align-items-start">
                                            <div class="pic">
                                                <img src="https://admin.haldoorvtc.org/uploads/graduations/<?php echo $image ?>" class="img-fluid" alt="" onerror="this.onerror=null;this.src='https://admin.haldoorvtc.org/assets/img/placeholder.png';">
                                            </div>
                                            <div class="member-info">
                                                ...
                                                <div class="mt-2">
                                                    <a class="btn btn-primary" href="graduations/detail.php?id=<?php echo $id; ?>">Watch</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                   
    ...
    <script> document.getElementById('graduation-navigations').classList.add("active") </script>
